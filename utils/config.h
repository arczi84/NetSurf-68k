...
#if (defined(_GNU_SOURCE) && !defined(__APPLE__) || defined(__amigaos4__) || defined(__HAIKU__) || (defined(_POSIX_C_SOURCE) && ((_POSIX_C_SOURCE - 0) >= 200809L)) && !defined(__riscos__)) || ((defined(__AMIGA__) && defined(__ixemul__)))
#define HAVE_STRNDUP
#else
#undef HAVE_STRNDUP
